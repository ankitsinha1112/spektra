...
export const getProducts =
    (keyword = "", category,type, price = [0, 200000], ratings = 0, currentPage = 1) => async (dispatch) => {
        try {
            ...
            if (category) {
                ...
                if (type) {
                    url = `/api/v1/products?keyword=${keyword}&type=${type}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}&page=${currentPage}`;
                }
            }
            else{
                if (type) {
                    ...
                    url = `/api/v1/products?keyword=${keyword}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}&page=${currentPage}`;
                }
            }
