...
const Product = ({ _id, name, images, ratings, numOfReviews, price, cuttedPrice, click }) => {
    ...
    return (
        <div className="flex flex-col items-start gap-2 px-4 py-6 relative hover:shadow-lg rounded-sm" onClick={click}>
            {/* <!-- image & product title --> */}
            <div className="flex flex-col items-center text-center group" style={{width:'100%',height:'60vh',backgroundImage: `url(${images && images[0].url})`, backgroundPosition: 'center', backgroundSize: 'cover',backgroundRepeat:'no-repeat'}}>
